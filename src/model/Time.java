...
/**
 * This class will provide an interface between TimeLord and Joda-Time objects.
 * This will hopefully reduce the code clutter needed to produce formatted dates
 * and times and will act as a single point to change the format of either.
 */
public class Time
{
    /**
     ...
     * 
     * @return - a Joda Period object with the difference in time between start
     *         and stop
     */
    ...
    public static String displayDelta(Period delta)
    {
        ...
        deltaString = hours + hoursLabel + " " + minutes + minutesLabel;
    ...
    /**
     * This is a string containing a date that is easy to use as a reference
     * e.g. when referring to a date in the database.
     * 
