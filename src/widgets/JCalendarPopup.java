 ...
 * 
 * @author Don Corley <don@donandann.com>
 * @version 1.4.3 Copyright (C) 2010 Don Corley
 * 
...
public class JCalendarPopup extends JPanel implements MouseListener
{
	...
	public void layoutCalendar( Date dateTarget )
	{
		...
		targetComponent =
		    (int)((targetDate.getTime() - dateCalendarFirstDate.getTime()) / KMS_IN_A_DAY);
	...
	private void initComponents()
	{
		...
		monthPanel.setPreferredSize( new Dimension( 200, 40 ) );
		monthPanel.setBackground( new Color( 115, 121, 136 ) );
		...
		previousMonthButton.setPreferredSize( new Dimension( 30, 15 ) );
		previousMonthButton.setName( "previousMonthButton" );
		monthLabel = new JLabel();
		monthLabel.setForeground( Color.WHITE );
		monthLabel.setFont( new Font( "Lucida Grande", 1, 20 ) );
		monthLabel.setName( "monthLabel" );
		previousMonthButton.setMargin( new Insets( 2, 10, 2, 2 ) );
		...
		nextMonthButton.setPreferredSize( new Dimension( 30, 15 ) );
		nextMonthButton.setName( "nextMonthButton" );
		nextMonthButton.setAlignmentX( 1.0F );
		nextMonthButton.setMargin( new Insets( 2, 2, 2, 10 ) );
		...
		panelDays.setBorder( new EmptyBorder( 10, 5, 5, 5 ) );
